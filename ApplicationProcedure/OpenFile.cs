...
namespace i_VXRFS.ApplicationProcedure
{
    ...
    {
        //文件保存路径全局变量，路径最后不要带 "\"
        public static string SYS_PATH = Public_Path.SysStandardSampleLibraryPath;
        ...
        {
            foreach (string name in Directory.GetFiles(SYS_PATH, "*.db"))
            {
