...
{
    public partial class CheckWDXRF : Form
    {
        public CheckWDXRF()
        {
            InitializeComponent();
        ...
        public CheckWDXRF(PerformanceTest_mainPage f1)
            :this()
        {
            this.phdAForm = f1;
        }
        ...
        private void CheckWDXRF_QuantitationAnalysis_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                txtb_step.Text = "0.1";//step的值估计需要变动
