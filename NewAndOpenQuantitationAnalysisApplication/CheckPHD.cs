...
{
    public partial class CheckPHD : Form
    {
        public CheckPHD()
        {
            InitializeComponent();
        ...
        public CheckPHD(newquantitationanalysisapplication phdaForm)
            : this()
        {
            this.phdAForm = phdaForm;
        }
        private quantitationanalysisapplication phdAForm2;
        public CheckPHD(quantitationanalysisapplication f2)
            : this()
        {
            this.phdAForm2 = f2;
        }
        ...
        private void CheckPHD_QuantitaionAnalysis_Load(object sender, EventArgs e)
        {
            ...
            txtb_steptime.Text = dataA[4].ToString();
            txtb_step.Text = dataA[6].ToString();
            txtb_step.ReadOnly = true;
            txtb_steptime.ReadOnly = true;
            cbox_mask.Text = "20";
        ...
        private void btn_ok_Click(object sender, EventArgs e)
        {
            ...
            if (identifyStr == "new")
            {
                phdAForm.dgv3.Rows[DgvIndex].Cells[13].Value = getelementparameter[13];
                phdAForm.dgv3.Rows[DgvIndex].Cells[14].Value = getelementparameter[14];
                phdAForm.dgv3.Rows[DgvIndex].Cells[21].Value = DateTime.Now.ToString("yyyy/MM/dd");
            }
            else if (identifyStr == "open")
            {
                phdAForm2.dgv3.Rows[DgvIndex].Cells[13].Value = getelementparameter[13];
                phdAForm2.dgv3.Rows[DgvIndex].Cells[14].Value = getelementparameter[14];
