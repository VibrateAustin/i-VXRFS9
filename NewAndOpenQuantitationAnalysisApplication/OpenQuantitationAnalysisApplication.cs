...
{
    public partial class OpenQuantitationAnalysisApplication : Form
    {
        public OpenQuantitationAnalysisApplication()
        {
            InitializeComponent();
        }
        ...
        private void btn_ok_Click(object sender, EventArgs e)
        {
            ...
            quantitationanalysisapplication quantitationanalysisapplicationform = new quantitationanalysisapplication();
